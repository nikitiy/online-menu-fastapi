...
Revision ID: 5aa33bc99922
Revises: 
Create Date: 2025-10-25 12:07:53.578679
...
def upgrade() -> None:
    ...
    op.create_index('uq_company_member_company_role_owner', 'company_members', ['company_id', 'role'], unique=True, postgresql_where="role = 'OWNER'")
...
def downgrade() -> None:
    ...
    op.drop_index('uq_company_member_company_role_owner', table_name='company_members', postgresql_where="role = 'OWNER'")
