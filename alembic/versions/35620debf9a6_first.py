...
Revision ID: 35620debf9a6
Revises:
Create Date: 2025-11-01 17:32:37.254929
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                ...
                "BAR",
                "OTHER",
                name="company_establishment_type",
            ),
            nullable=False,
        ),
        sa.Column(
            "cuisine_category",
            postgresql.ENUM("JAPANESE", "RUSSIAN", "OTHER", name="cuisine_category"),
            nullable=False,
        ),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_countries_code_alpha2"), "countries", ["code_alpha2"], unique=True
    )
    op.create_index(op.f("ix_countries_name"), "countries", ["name"], unique=False)
    op.create_index(
        op.f("ix_countries_name_en"), "countries", ["name_en"], unique=False
    )
    op.create_table(
        "site_configuration",
        ...
        sa.CheckConstraint(
            "id = 1", name=op.f("ck_site_configuration_ck_site_configuration_singleton")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("OWNER", "ADMIN", "EDITOR", "VIEWER", name="company_role"),
            nullable=False,
        ),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk_company_members_company_id_companies"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
        ...
        sa.UniqueConstraint(
            "company_id", "user_id", name="uq_company_member_company_user"
        ),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_company_members_created_at"),
        "company_members",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_members_updated_at"),
        "company_members",
        ["updated_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_menu_items_ck_menu_item_template_owner_consistency"),
        ),
        sa.CheckConstraint(
            "carbohydrated IS NULL OR carbohydrated > 0",
            name=op.f("ck_menu_items_ck_menu_item_carbohydrated_pos"),
        ),
        sa.CheckConstraint(
            "fats IS NULL OR fats > 0", name=op.f("ck_menu_items_ck_menu_item_fats_pos")
        ),
        sa.CheckConstraint(
            "grams > 0", name=op.f("ck_menu_items_ck_menu_item_grams_pos")
        ),
        sa.CheckConstraint(
            "kilocalories IS NULL OR kilocalories > 0",
            name=op.f("ck_menu_items_ck_menu_item_kilocalories_pos"),
        ),
        sa.CheckConstraint(
            "proteins IS NULL OR proteins > 0",
            name=op.f("ck_menu_items_ck_menu_item_proteins_pos"),
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
        ...
        sa.ForeignKeyConstraint(
            ["owner_company_id"],
            ["companies.id"],
            name=op.f("fk_menu_items_owner_company_id_companies"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_menu_items")),
    )
    op.create_index(
        "ck_menu_item_category_slug",
        "menu_items",
        ["category_id", "slug"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_menu_items_owner_company_id"),
        "menu_items",
        ["owner_company_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_menu_items_updated_at"), "menu_items", ["updated_at"], unique=False
    )
    op.create_table(
        "oauth_accounts",
        sa.Column("user_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_oauth_accounts_user_id_users")
        ),
    ...
    op.create_index(
        op.f("ix_oauth_accounts_updated_at"),
        "oauth_accounts",
        ["updated_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk_sites_company_id_companies"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["menu_item_id"],
            ["menu_items.id"],
            name=op.f("fk_menu_images_menu_item_id_menu_items"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_menu_images")),
    )
    op.create_index(
        op.f("ix_menu_images_created_at"), "menu_images", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_menu_images_menu_item_id"),
        "menu_images",
        ["menu_item_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_menu_images_updated_at"), "menu_images", ["updated_at"], unique=False
    )
    op.create_table(
        "streets",
        sa.Column("name", sa.String(length=255), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["city_id"],
            ["cities.id"],
            name=op.f("fk_streets_city_id_cities"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_streets_longitude"), "streets", ["longitude"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["street_id"],
            ["streets.id"],
            name=op.f("fk_addresses_street_id_streets"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_addresses")),
    )
    op.create_index(
        op.f("ix_addresses_external_id"), "addresses", ["external_id"], unique=False
    )
    op.create_index(
        op.f("ix_addresses_latitude"), "addresses", ["latitude"], unique=False
    )
    op.create_index(
        op.f("ix_addresses_longitude"), "addresses", ["longitude"], unique=False
    )
    op.create_index(
        op.f("ix_addresses_postal_code"), "addresses", ["postal_code"], unique=False
    )
    op.create_index(
        op.f("ix_addresses_street_id"), "addresses", ["street_id"], unique=False
    )
    op.create_table(
        "company_branches",
        sa.Column("company_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["address_id"],
            ["addresses.id"],
            name=op.f("fk_company_branches_address_id_addresses"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk_company_branches_company_id_companies"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_company_branches")),
    )
    op.create_index(
        op.f("ix_company_branches_address_id"),
        "company_branches",
        ["address_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_branches_external_id"),
        "company_branches",
        ["external_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_branches_latitude"),
        "company_branches",
        ["latitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_branches_longitude"),
        "company_branches",
        ["longitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_branches_name"), "company_branches", ["name"], unique=False
    )
    op.create_table(
        "geocoding_results",
        ...
        sa.ForeignKeyConstraint(
            ["address_id"],
            ["addresses.id"],
            name=op.f("fk_geocoding_results_address_id_addresses"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_geocoding_results")),
    )
    op.create_index(
        op.f("ix_geocoding_results_address_id"),
        "geocoding_results",
        ["address_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_external_id"),
        "geocoding_results",
        ["external_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_latitude"),
        "geocoding_results",
        ["latitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_longitude"),
        "geocoding_results",
        ["longitude"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_place_id"),
        "geocoding_results",
        ["place_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_provider"),
        "geocoding_results",
        ["provider"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geocoding_results_query"), "geocoding_results", ["query"], unique=False
    )
    op.create_table(
        "company_branches_menus",
        ...
        sa.ForeignKeyConstraint(
            ["company_branch_id"],
            ["company_branches.id"],
            name=op.f("fk_company_branches_menus_company_branch_id_company_branches"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["menu_item_id"],
            ["menu_items.id"],
            name=op.f("fk_company_branches_menus_menu_item_id_menu_items"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_company_branches_menus")),
    )
    op.create_index(
        op.f("ix_company_branches_menus_company_branch_id"),
        "company_branches_menus",
        ["company_branch_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_branches_menus_menu_item_id"),
        "company_branches_menus",
        ["menu_item_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("last_scanned", postgresql.TIMESTAMP(timezone=True), nullable=True),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.CheckConstraint(
            "scan_count >= 0", name=op.f("ck_qr_codes_ck_qr_codes_scan_count_nonneg")
        ),
        sa.ForeignKeyConstraint(
            ["company_branch_id"],
            ["company_branches.id"],
            name=op.f("fk_qr_codes_company_branch_id_company_branches"),
            ondelete="CASCADE",
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_company_branches_menus_menu_item_id"),
        table_name="company_branches_menus",
    )
    op.drop_index(
        op.f("ix_company_branches_menus_company_branch_id"),
        table_name="company_branches_menus",
    )
    op.drop_table("company_branches_menus")
    ...
    op.drop_index(
        op.f("ix_geocoding_results_longitude"), table_name="geocoding_results"
    )
    op.drop_index(op.f("ix_geocoding_results_latitude"), table_name="geocoding_results")
    op.drop_index(
        op.f("ix_geocoding_results_external_id"), table_name="geocoding_results"
    )
    op.drop_index(
        op.f("ix_geocoding_results_address_id"), table_name="geocoding_results"
    )
    ...
    op.drop_index(
        op.f("ix_company_branches_external_id"), table_name="company_branches"
    )
